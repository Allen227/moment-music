...
// FETCH SONG WORD
export const FETCH_SONG_WORD = {
  SUCCESS: 'FETCH_SONG_WORD_SUCCESS',
  ERROR: 'FETCH_SONG_WORD_ERROR'
};
export type FETCH_SONG_WORD_SUCCESS = typeof FETCH_SONG_WORD.SUCCESS;
export type FETCH_SONG_WORD_ERROR = typeof FETCH_SONG_WORD.ERROR;
